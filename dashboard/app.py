...
def get_order_counts():
    ...
    try:
        ...
        print(
            f"Order count query error: {error}"
        )
    ...
    try:
        ...
        with connection.cursor() as cursor:
            ...
            confirmed_revenue = float(
                revenue["confirmed_revenue"] or 0
            )
        ...
        print(
            f"Business metrics error: {error}"
        )
...
def get_top_products():
    ...
    try:
        ...
        print(
            f"Top product query error: {error}"
        )
...
def get_daily_revenue():
    ...
    try:
        ...
        print(
            f"Daily revenue query error: {error}"
        )
    ...
    if request.method == "POST":
        ...
        if not token:
            ...
            return render_template(
                ...
                login_error=
                    "Please enter an admin token."
            )

        admin = authenticate_admin_token(
            token
        )
